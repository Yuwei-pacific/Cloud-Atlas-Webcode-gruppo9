...
window.addEventListener('scroll', d => {
  ...
  img[0].classList.toggle('visible', scrollY >= page[11].offsetTop && scrollY <= page[12].offsetTop)
  img[1].classList.toggle('visible', scrollY >= page[12].offsetTop && scrollY <= page[13].offsetTop)
  img[2].classList.toggle('visible', scrollY >= page[13].offsetTop && scrollY <= page[14].offsetTop)
  img[3].classList.toggle('visible', scrollY >= page[14].offsetTop && scrollY <= page[15].offsetTop)
  img[4].classList.toggle('visible', scrollY >= page[15].offsetTop && scrollY <= page[16].offsetTop)
  img[5].classList.toggle('visible', scrollY >= page[16].offsetTop && scrollY <= page[17].offsetTop)
  img[6].classList.toggle('visible', scrollY >= page[17].offsetTop && scrollY <= page[18].offsetTop)
  img[7].classList.toggle('visible', scrollY >= page[18].offsetTop && scrollY <= page[19].offsetTop)
  img[8].classList.toggle('visible', scrollY >= page[19].offsetTop && scrollY <= page[20].offsetTop)
  img[9].classList.toggle('visible', scrollY >= page[20].offsetTop && scrollY <= page[21].offsetTop)
})
